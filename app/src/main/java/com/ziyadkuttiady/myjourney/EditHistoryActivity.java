...
public class EditHistoryActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (cursor.moveToNext()) {
            ...
            editTextVehicleCategory.setSelection(((ArrayAdapter) editTextVehicleCategory.getAdapter()).getPosition(cursor.getString(10)));

            //VehicleCategory
//            editTextVehicleCategory.setSelected(cursor.getString(10));
